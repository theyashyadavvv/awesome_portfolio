...
//           <div class="blog-slider__title">${SAKEC (Vega)}</div>
//           <span class="blog-slider__code">${subtitle}</span>
//           <div class="blog-slider__text">${desp}</div>
//           <a href="${"https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/0e54af4f-11d3-4ef5-a640-7d83b3e55c25.pdf"}" class="blog-slider__button">Read More</a>   
//         </div>
//       </div>
//       `)
//   );
